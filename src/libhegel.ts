 ...
 * `hegel-rust/hegel-c/include/hegel.h`, version 0.36.6) via {@link koffi}.
 *
 ...
 * absorbed as NULL (engine output stays on stderr), as is the optional
 * constraining `alphabet` of `hegel_string_generator_regex` (this client never
 * restricts a regex generator's alphabet, so it always passes NULL).
 */
